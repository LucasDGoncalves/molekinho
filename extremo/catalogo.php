...
<body>
  ...
  function display_product($produto, &$height){
    ...
    //980 é o maximo que a altura da pagina pode atingir, 178 é a atual altura da div de produto, ou seja se tiver mais avançado que 772, quebra a linha
    if ($height<= 844){
    ...
    $image_reized = 'phpThumb/phpThumb.php?src=../images/'.$produto["id"].'.jpg&h=150';
